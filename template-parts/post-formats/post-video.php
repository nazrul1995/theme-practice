...
<div class="feature-img-thumb relative">
    <div class="video-box">
        ...
        <div id="thumbnail_container" class="thumbnail_container">
            <?php the_post_thumbnail("mymag-home-large") ?>
            <div class="overlay overlay-bg"></div>
        </div>
        <a href="<?php echo esc_url($mymag_video_file);?>" class="start-video"><img src="<?php echo get_template_directory_uri() ?>../assets/img/play-icon.png" alt=""></a>
    </div>
</div>
